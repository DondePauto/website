...
@section('content')
    <div class="row activar-content">
        <div class="container-fluid text-center">
            ...
            <h2 class="h2">
                Tu cuenta ha sido activada. Al presentar tus ofertas en <a href="{{ route('home') }}">DóndePauto</a> obtienes mayor visibilidad,
                alcance y la posibilidad de ampliar tus ventas.
            </h2>
                ...
                <div class="col-12 col-sm-5 form-fields">
                    ...
                    <ul class="fa-ul">
                        <li>
                            ...
                            <span>Accedes a todo nuestro inventario de ofertas donde podrás visualizar precios de referencia de medios similares</span>
                            <br><br>
                        </li>
                        <li>
                            <i class="fa fa-fw fa-lg fa-li fa-check-circle text-success"></i>
                            <span>Habilitas la opción para presentar tus ofertas a través de la plataforma</span>
                            <br><br>
                        </li>
                        <li>
                            <i class="fa fa-fw fa-lg fa-li fa-check-circle text-success"></i>
                            <span>Establecer contacto con el área de compras y negociaciones</span>
                            <br><br>
                        </li>
                        <li>
                            <i class="fa fa-fw fa-lg fa-li fa-check-circle text-success"></i>
                            <span>Podrás conocer todo acerca del modelo de servicio: precios de lista al público, como recibes el pago por tus servicios o productos vendidos, etc.</span>
                            <br><br>
                        </li>
                    </ul>
                </div>
